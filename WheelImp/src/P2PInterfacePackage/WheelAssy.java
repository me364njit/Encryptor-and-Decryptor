...
public class WheelAssy {
  ...
  //
  private static WheelAssy instance = null;
  ...
  public static WheelAssy Instance() {
    if (instance == null) instance = new WheelAssy();
    return instance;
  }
  ...
  public void advance() {
    ...
    final boolean w2atNotch2 = (w2atNotch && !w2.atNotch());
  ...
  public void reverse() {
    ...
    final boolean w2atNotch2 = (w2.atNotch() && !w2atNotch);
